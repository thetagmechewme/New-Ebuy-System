...
import { createPaymentIntent } from '../functions/stripe.function';
...
import {cartConst, couponConst} from '../actions/constants';
...
const StripeCheckout = ({ history }) => {
    ...
    useEffect(() => {
        createPaymentIntent(user.token, coupon).then((res) => {
            ...
            //Additional response received after successful payment
